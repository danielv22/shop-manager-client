                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr v-for="(m, i) in list">
                      ...
                      <td class="py-0 px-1">
                      <span class="badge " :class="[m.stock<m.minimum_stock?'badge-danger':'badge-success']"
                      >{{ m.stock }} {{ m.measurement.code }} </span>
                    </td>
                      <td class="py-0 px-1">{{ Number( m.investment).toFixed(2) }}</td>
                      <td class="py-0 px-1">{{ Number( m.valued).toFixed(2) }}</td>
                      <td class="py-0 px-1">{{ Number( m.gain).toFixed(2) }}</td>
                      <td class="py-0 px-1">
                        <div class="btn-group">
                          <nuxtLink
                            :to="url_modify + m.id"
