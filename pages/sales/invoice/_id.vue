                ...
                <div class="row">
                  <div class="col-12" v-for="m in model.stockSale">
                    <div class="d-flex">
                      ...
                      <div>
                        <h6 class="text-lg mb-0 mt-2">{{ m.stock.product.name }}</h6>
                        <p class="text-sm mb-3">
                          {{ Number(m.price).toFixed(2) }} x {{ m.amount }} {{ m.stock.product.measurement.code }}
                        </p>
                        <span class="badge badge-sm bg-gradient-success"> <i class="fas fa-barcode"></i> {{ m.stock.product.barcode }}</span>
                      </div>
                    </div>
                  </div>
