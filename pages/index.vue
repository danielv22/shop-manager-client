<template>
                 ...
                 <div class="row">
                   <div class="col-8">
                     <div class="numbers">
                       ...
                       <h5 class="font-weight-bolder mb-0">
                        {{Number(dashboard.purchases).toFixed(2)}}
                 ...
                 <div class="row">
                   <div class="col-8">
                     <div class="numbers">
                       ...
                       <h5 class="font-weight-bolder mb-0">
                        {{Number(dashboard.sales).toFixed(2)}}
                         <span class="text-success text-sm font-weight-bolder"
                           ></span
                         >
                       </h5>
 ...
 new Chart(ctx2, {
   type: "line",
   data: {
     labels: self.dashboard.months.map((m)=>m.month),
     datasets: [
       {
         label: "Sales",
         tension: 0.4,
         ...
         fill: true,
         data: self.dashboard.months.map((m)=>m.total),
         maxBarThickness: 6,
       },
     ],
   },
